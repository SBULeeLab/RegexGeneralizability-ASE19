...
extractorDir = os.path.join(os.environ['REGEX_GENERALIZABILITY_PROJECT_ROOT'], 'corpus', 'corpus-creation', 'static-analysis')
langToExtractorPath = {
    'javascript': os.path.join(extractorDir, 'js', 'extract-js-regexps.js'),
    'typescript': os.path.join(extractorDir, 'ts', 'extract-ts-regexes.py'), 
    'python': os.path.join(extractorDir, 'python', 'extract-python-regexes-wrapper.pl'),
    'java': os.path.join(extractorDir, 'java', 'regex-extractor', 'release', 'regex-extractor-1.0.jar'),
}
